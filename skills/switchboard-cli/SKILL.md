...
description: Use the Switchboard CLI to manage Powerhouse Switchboard drives, documents, folders, mutations, exports/imports, analytics, real-time subscriptions, and raw GraphQL. Apply when the user wants to work with Switchboard from the terminal, create/edit document models, query or mutate documents, run arbitrary GraphQL, watch changes, or move data between instances.
---
